...
{
	if(argc == 3){  //case where both the file names are given i.e both the input file name and the destination file name
    ...
    else if(argc==2){      //case when only the input file name is given
		color_table ct[256];
